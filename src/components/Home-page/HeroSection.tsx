        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 xs:gap-8 sm:gap-10 md:gap-12 lg:gap-16">
          <div className="w-full md:w-5/12 mb-8 md:mb-0 order-2 md:order-1">
            <div className="relative">
              <div className="absolute -left-2 xs:-left-3 -top-2 xs:-top-3 w-12 xs:w-26 sm:w-20 md:w-24 h-12 xs:h-16 sm:h-20 md:h-24 border-t-2 border-l-2 border-bejeAbobora/60"></div>
              <img
          ...
          <div className="w-full md:w-7/12 text-center md:text-left order-1 mbl:mt-8 md:order-2 px-1 xs:px-2 sm:px-0">
            <div className="inline-block mb-2 xs:mb-3 sm:mb-2">
              <span className="text-bejeAbobora font-SpectralRegular italic text-sm xs:text-base sm:text-base">— Bem-vinda(o) —</span>
            </div>
            
            <h1 className="font-SpectralRegular text-2xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-marrondarck mb-4 sm:mb-5 md:mb-6 leading-normal sm:leading-relaxed">
            ...
            <p className="text-marronLight/90 text-base xs:text-base sm:text-lg md:text-xl font-MontserratRegular leading-relaxed mb-5 sm:mb-6 md:mb-8 max-w-xl md:max-w-2xl">
            ...
            <div className="mt-6 xs:mt-7 sm:mt-8 md:mt-10">
              <a
                href="/sobre"
                className="relative inline-block font-MontserratRegular text-marrondarck text-sm xs:text-sm sm:text-base md:text-lg group"
                onClick={scrollToTop}
              >
