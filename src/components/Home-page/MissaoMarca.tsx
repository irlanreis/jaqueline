      ...
      <div className="container mx-auto px-3 sm:px-4 md:px-6">
        <div className="max-w-3xl mx-auto mb-8 sm:mb-10 md:mb-14 text-center">
          <div className="inline-block mb-2 xs:mb-3">
            <span className="text-bejeAbobora font-SpectralRegular italic text-xs xs:text-sm sm:text-base">— Nossa missão —</span>
          </div>
          <h2 className="font-SpectralRegular text-xl xs:text-2xl sm:text-3xl md:text-4xl text-marrondarck mb-3 sm:mb-4 md:mb-5">
            O que nos move
          </h2>
        ...
        <div className="flex flex-col md:flex-row items-center gap-6 xs:gap-8 sm:gap-10 md:gap-12 lg:gap-16">
          <div className="md:w-5/12">
            <div className="prose prose-lg text-marronLight/90 max-w-none">
              <p className="text-sm xs:text-base sm:text-lg leading-relaxed mb-3 sm:mb-4 md:mb-6 font-MontserratRegular">
              ...
              <div className="mt-6 xs:mt-7 sm:mt-8 md:mt-10 border-t border-bejeAbobora/20 pt-4 sm:pt-6">
                <p className="italic text-marronLight/80 text-left text-xs xs:text-sm sm:text-base md:text-lg font-SpectralRegular w-11/12 sm:w-10/12">
