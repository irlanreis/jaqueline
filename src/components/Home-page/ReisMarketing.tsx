      ...
      <div className="container mx-auto px-3 sm:px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-block mb-2 xs:mb-3">
            <span className="text-bejeAbobora font-SpectralRegular italic text-sm xs:text-base sm:text-base">— Nossa agência —</span>
          </div>
          <h2 className="font-SpectralRegular text-2xl xs:text-2xl sm:text-3xl md:text-4xl mb-3 sm:mb-4 md:mb-5">
            Reis Marketing RR
          </h2>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 lg:gap-16">
          <div className="md:w-2/5 text-center md:text-left">
            ...
            <p className="text-base xs:text-base sm:text-lg leading-relaxed mb-6 sm:mb-8 font-MontserratRegular text-bejeLigth/90">
            ...
            <div className="mt-6 sm:mt-8">
              <a 
                ...
                className="inline-flex items-center gap-2 sm:gap-3 border-b border-bejeAbobora text-bejeAbobora hover:text-bejeAbobora/80 transition-colors font-MontserratRegular pb-1 text-base xs:text-base"
              >
                Conheça nossa agência <ArrowRight size={16} className="xs:w-4 sm:w-5" />
              </a>
            </div>
          </div>
          ...
          <div className="md:w-1/2 mt-8 md:mt-0">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 md:gap-6">
              <div className="border border-bejeAbobora/20 p-4 xs:p-5 sm:p-6 md:p-7">
                <h3 className="text-bejeAbobora text-lg xs:text-lg font-SpectralRegular mb-2 sm:mb-3">Gestão de Redes Sociais</h3>
                <p className="text-bejeLigth/80 font-MontserratRegular text-sm xs:text-sm leading-relaxed">
                  Estratégias personalizadas para conectar sua marca ao público certo.
                </p>
              </div>
              
              <div className="border border-bejeAbobora/20 p-4 xs:p-5 sm:p-6 md:p-7">
                <h3 className="text-bejeAbobora text-lg xs:text-lg font-SpectralRegular mb-2 sm:mb-3">Identidade Visual</h3>
                <p className="text-bejeLigth/80 font-MontserratRegular text-sm xs:text-sm leading-relaxed">
              ...
              <div className="border border-bejeAbobora/20 p-4 xs:p-5 sm:p-6 md:p-7">
                <h3 className="text-bejeAbobora text-lg xs:text-lg font-SpectralRegular mb-2 sm:mb-3">Produção de Conteúdo</h3>
                <p className="text-bejeLigth/80 font-MontserratRegular text-sm xs:text-sm leading-relaxed">
              ...
              <div className="border border-bejeAbobora/20 p-4 xs:p-5 sm:p-6 md:p-7">
                <h3 className="text-bejeAbobora text-lg xs:text-lg font-SpectralRegular mb-2 sm:mb-3">Tráfego Pago</h3>
                <p className="text-bejeLigth/80 font-MontserratRegular text-sm xs:text-sm leading-relaxed">
